...
(function () {
  ...
  var PRODUCTS = {
    ...
    "typixdeck-cm4": { img: "/assets/cyberdeck.png", usd: 214,
      name: { en: "TypixDeck · CM4 4GB (+ battery)", zh: "TypixDeck · CM4 4GB（含电池）", ja: "TypixDeck · CM4 4GB（バッテリー付）" } },
    "typixdeck-cm5": { img: "/assets/cyberdeck.png", usd: 224,
      name: { en: "TypixDeck · CM5 4GB (+ battery)", zh: "TypixDeck · CM5 4GB（含电池）", ja: "TypixDeck · CM5 4GB（バッテリー付）" } },
    "typixdeck-cm0": { img: "/assets/cm0-adapter.png", usd: 159,
      name: { en: "TypixDeck · CM0 (soldered adapter)", zh: "TypixDeck · CM0（含贴片转接板）", ja: "TypixDeck · CM0（実装済アダプタ付）" } },
  ...
  var I18N = {
    en: {
      ...
      "pin.fanless": "Fanless · CM0/CM4", "pin.stock": "Pre-order", "pin.silent": "Truly silent",
      "save.title": "PRE-ORDER", "save.sub": "ships in 2 wks – 2 mo",
      ...
      "deck.pricenote": "· body only — no battery / compute module · free worldwide shipping",
      ...
      "kb.pricenote": "· Bluetooth · wired version $29 · free worldwide shipping",
      "kb.wired": "Wired",
      "deck.trust": "Pre-order · ships in 2 weeks – 2 months · full refund before shipping · 4,200+ makers",
      ...
      "f.2t": "Truly silent — 0 dB", "f.2p": "The milled chassis is the heatsink — no fan, no vents, no dust. CM0 and CM4 run completely silent at 0 dB. For CM5's extra power, a dedicated CNC case with a 4-pin PWM fan header is in the works.",
      ...
      "faq.q4": "When does my pre-order ship?", "faq.a4": "All items are pre-orders, built in small batches. Estimated dispatch is 2 weeks – 2 months from order; we email tracking when it ships. Free worldwide shipping, and a full refund any time before yours ships. Duties may apply depending on your region.",
      ...
      "support.s1t": "Pre-order & shipping", "support.s1p": "All items are pre-orders, made in small batches. Estimated dispatch is 2 weeks – 2 months from order, with free worldwide shipping. We email tracking the moment yours ships. Duties may apply on some routes.",
    ...
    zh: {
      ...
      "pin.fanless": "无风扇 · CM0/CM4", "pin.stock": "预售", "pin.silent": "全程静音",
      "save.title": "预售", "save.sub": "2 周–2 个月发货",
      ...
      "deck.ship": "· 全球免运费",
      "deck.pricenote": "· 仅机身 — 不含电池 / 计算模块 · 全球免运费",
      ...
      "kb.pricenote": "· 蓝牙 · 有线版 $29 · 全球免运费",
      "kb.wired": "有线",
      "deck.trust": "预售 · 2 周–2 个月发货 · 发货前全额退款 · 4,200+ 创客",
      ...
      "f.2t": "真正静音 — 0 dB", "f.2p": "整块铝合金机身即散热片——无风扇、无开孔、无积灰。CM0 与 CM4 在 0 dB 下完全静音运行。针对 CM5 更高的功耗，我们准备了带 4-pin PWM 调速风扇接口的专用 CNC 外壳（制作中）。",
      ...
      "faq.q4": "预售订单什么时候发货？", "faq.a4": "所有商品均为预售，按小批量制作。预计自下单起 2 周–2 个月内发货，发货时会邮件通知物流单号。全球免运费；发货前可随时申请全额退款。部分地区可能产生关税。",
      ...
      "support.s1t": "预售与物流", "support.s1p": "所有商品均为预售，小批量制作。预计自下单起 2 周–2 个月内发货,全球免运费。发货时会立即邮件通知物流单号。部分线路可能产生关税。",
    ...
    ja: {
      ...
      "pin.fanless": "ファンレス · CM0/CM4", "pin.stock": "予約販売", "pin.silent": "完全な静音",
      "save.title": "予約販売", "save.sub": "2週間〜2か月で発送",
      ...
      "deck.ship": "· 世界中送料無料",
      "deck.pricenote": "· 本体のみ — バッテリー / 計算モジュール別売 · 世界中送料無料",
      "deck.cm0": "+ CM0（CM0→CM4 アダプタ実装済）",
      "deck.cm4": "+ CM4 4GB 完成品（バッテリー付）",
      "deck.cm5": "+ CM5 4GB 完成品（バッテリー付）",
      "kb.pricenote": "· Bluetooth · 有線版 $29 · 世界中送料無料",
      "kb.wired": "有線",
      "deck.trust": "予約販売 · 2週間〜2か月で発送 · 発送前は全額返金 · 4,200+ メイカー",
      ...
      "f.2t": "完全な静音 — 0 dB", "f.2p": "削り出しボディそのものがヒートシンク——ファンも通気孔も埃もなし。CM0 と CM4 は 0 dB で完全に無音動作。CM5 の高い消費電力向けには、4-pin PWM ファン端子付きの専用 CNC ケースを準備中です。",
      ...
      "faq.q4": "予約商品はいつ発送されますか？", "faq.a4": "すべて予約販売で、小ロットで製作します。発送目安はご注文から 2週間〜2か月で、発送時に追跡番号をメールでお知らせします。世界中送料無料、発送前ならいつでも全額返金。地域により関税がかかる場合があります。",
      ...
      "support.s1t": "予約販売と配送", "support.s1p": "すべて予約販売で、小ロット製作です。発送目安はご注文から 2週間〜2か月、世界中送料無料。発送時に追跡番号をすぐメールでお知らせします。一部経路で関税が発生する場合があります。",
